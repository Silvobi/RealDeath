...
The assets packaged with mod are entirely made by me without any AI help. SPOILER: ||for example `death-ambient.ogg` was made in FL Studio. I generated noise using 3x Osc VST Plugin and put some effect over it.||
